...
require_text "Scripts/dogfood-acceptance.sh" "acceptance-performance-"
require_text "Scripts/dogfood-acceptance.sh" "Performance log:"
require_text "Scripts/dogfood-acceptance.sh" "tee"
...
require_text "DOGFOOD.md" "acceptance-performance-"
